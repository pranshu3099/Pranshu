    ...
    <body>
        ...
        <div class="content" id="content">
            <div class="content-left">
                ...
                <div class="icons">
                    ...
                    <a
                        href="https://www.linkedin.com/in/pranshu-srivastava-78a6001bb/"
        ...
        <div class="about" id="about">
            <div class="about-me" id="pot">
                <span>I</span> am a graduated engineering student. I like
                creating performant and accessible web applications with the
                latest tech such as Javascript , React js and currently i am
                working on Laravel.
            </div>
            ...
            <div class="sub-about">
                ...
                <div>
                    ...
                    <p class="p-2">
                        Worked as a web developer intern at the sparks
                        foundation
                    </p>
                </div>
            </div>
        ...
        <div class="myskills" id="myskills">
            ...
            <div>
                <p>
                    Web design and development have been my passion for more
                    over an year. I like working with JavaScript, HTML/CSS and
                    Laravel
                </p>
            </div>
        </div>
        <div class="box-container">
            <div class="box">
                <div>
                    ...
                    <h4>HTML-CSS</h4>
                    <p>
                        I am proficient in HTML/CSS I have made many websites
                ...
                <div>
                    ...
                    <h4>JavaScript</h4>
                    <p>
                        I love working with JavaScript and have made many
                        projects using various JS libraries and frameworks.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <h4>React js</h4>
                    <p>
                        I love working with Reactjs and have made many projects
                        using Reactjs.
                    </p>
                </div>
                <div>
                    <img
                        src="images/laravel-svgrepo-com.svg"
                        alt=""
                        class="img"
                    />
                    <h4>Laravel</h4>
                    <p>
                        I love working with Laravel and have made many projects
        ...
        <div class="projectbox-container">
            <div class="project-box">
                <div class="box-1">
                    <img
                        src="images/Screenshot from 2022-08-17 02-09-05.png"
                        alt=""
                    />
                    <p>
                        A web application where you can see synopsis of movies
                        and webseries made using HTML/CSS and JavaScript.
                        <a
                ...
                <div class="box-1">
                    <img
                        src="images/Screenshot from 2022-08-17 02-12-01.png"
                        alt=""
                    />
                    <p>
                        A public chat room service for any one to join made
                ...
                <div class="box-1">
                    <img
                        src="images/Screenshot from 2022-08-17 02-10-30.png"
                        alt=""
                    />
                    <p>
                        A digital Parking application using Reactjs, Firebase
                        and many latest technologies.
